"""
This code is adapted from PreDiff: https://github.com/gaozhihan/PreDiff, their licence is Apache 2.0 License.
"""
...
from data.SEVIR.SEVIRDataLoader import SEVIRDataLoader
...
class SEVIRSkillScore(Metric):
    ...
    def _BTCHWtoBHWT(self, x: torch.Tensor) -> torch.Tensor:
    ...
    def update(self, pred: torch.Tensor, target: torch.Tensor):
        pred = pred.reshape(-1, 13, *pred.shape[1:])  # todo
        target = target.reshape(-1, 13, *target.shape[1:])
