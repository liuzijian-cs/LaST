...
# Module List:
# 1. SpatialLocalPerceptionAttention
# 2. TemporalLocalPerceptionAttention

class SpatialLocalPerceptionAttention(nn.Module):
    def __init__(self,
                 d_model: int,
                 n_heads: int,
                 s_local: List[int],
        ...
        super(SpatialLocalPerceptionAttention, self).__init__()
...
class TemporalLocalPerceptionAttention(nn.Module):
    def __init__(self,
                 d_model: int,
                 n_heads: int,
                 s_local: int = 3,
        ...
        super(TemporalLocalPerceptionAttention, self).__init__()
