...
class PatchEmbedding(nn.Module):
    def __init__(self,
        ...
        self.patch_embed = BasicLinear(d_in=data_back[1] * (s_patch ** 2), d_out=d_model, activation=True)
        self.position_encode = SpatiotemporalPosEncoding2D(d_model=d_model, T=data_back[0], H=data_back[-2] // s_patch,
...
class ConvSwiGLU1d(nn.Module):
    def __init__(self,
        ...
        super(ConvSwiGLU1d, self).__init__()
...
class ConvSwiGLU2d(nn.Module):
    def __init__(self,
        ...
        super(ConvSwiGLU2d, self).__init__()
        d_hidden = d_model * r_forward
