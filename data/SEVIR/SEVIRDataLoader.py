...
PREPROCESS_OFFSET_01 = {'vis': 0,
                        ...
                        'lght': 0}
# sevir
SEVIR_CATALOG = os.path.join("data", "SEVIR", "sevir", "CATALOG.csv")
SEVIR_DATA_DIR = os.path.join("data", "SEVIR", "sevir", "data")
SEVIR_RAW_SEQ_LEN = 49
# sevir-lr
SEVIR_LR_CATALOG = os.path.join("data", "SEVIR", "sevirlr", "CATALOG.csv")
SEVIR_LR_DATA_DIR = os.path.join("data", "SEVIR", "sevirlr", "data")
